  ...
  <x-form-section submit="createApiToken">
    ...
    <x-slot name="form">
      ...
      <div class="col-span-6 sm:col-span-4">
        ...
        <x-input class="mt-1 block w-full" id="name" type="text" wire:model="createApiTokenForm.name" autofocus />
          ...
          <div class="mt-2 grid grid-cols-1 gap-4 md:grid-cols-2">
            @foreach (Laravel\Jetstream\Jetstream::$permissions as $permission)
              <label class="flex items-center">
                ...
                <span class="ms-2 text-sm text-white dark:text-gray-400">{{ $permission }}</span>
              </label>
            @endforeach
          </div>
        </div>
  ...
  <x-dialog-modal wire:model.live="displayingToken">
    ...
    <x-slot name="content">
      ...
      <x-input class="mt-4 w-full break-all rounded bg-gray-100 px-4 py-2 font-mono text-sm text-gray-500"
        type="text" x-ref="plaintextToken" readonly :value="$plainTextToken" autofocus autocomplete="off" autocorrect="off"
